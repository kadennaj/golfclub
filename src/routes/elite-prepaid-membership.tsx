...
export const Route = createFileRoute("/elite-prepaid-membership")({
  head: () => ({
    meta: [
      { title: "Elite Prepaid Membership — Richmond Hill Golf Club" },
      {
        name: "description",
        content:
          "Save 15–25% on green fees with an Elite Prepaid Membership account at Richmond Hill Golf Club. Three tiers: Silver, Gold and Platinum.",
      },
      { property: "og:title", content: "Elite Prepaid Membership — Richmond Hill Golf Club" },
      {
  ...
  component: ElitePrepaidMembershipPage,
});
...
function ElitePrepaidMembershipPage() {
  useReveal();
  return (
    <>
      <PageHero
